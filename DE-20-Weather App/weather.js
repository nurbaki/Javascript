...
// localStorage.setItem("apiKey", "4d8fb5b93d4af21d66a2948710284366");
...
const getWeatherDataFromApi = async() =>{
    ...
    if(cityListCardsArray.length > 0){
        const filteredArray = cityListCardsArray.filter(cityCard => cityCard.querySelector("span").innerText == name);
