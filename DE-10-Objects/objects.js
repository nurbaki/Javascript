...
//!NOTE: arrow functions ın sözcüksel bağlamı vardır. Yani this keyword ü bir arrow function 
// içinde kullanırsak beklenmedik değerler alabiliriz. Bir object in içindeki this keyword ü,
//  global scope u (window) ifade ettiği için. this value nun global scope a bağlanmasını önlemek için,
//   object yöntemi içindeki normal function u kullanın.

// key lerin belirli bir sırası (index) olmadığı için object araması daha tutarlı bir arama performansına sahip olacaktır.
//  Ayrıca diziler arasında döngü yapmak, keys arasında döngü yapmaktan daha hızlıdır, bu nedenle tüm öğeler üzerinde 
...
const people = [
  ...
  // * example 1:: people dizisindeki joblari göster 

  people.forEach((p)=> console.log(p.name , p.job));


  
  // * example 2: yaslari birer artir sonucu baska bir diziye aktar 
